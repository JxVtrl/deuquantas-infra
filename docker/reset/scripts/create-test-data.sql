...
DECLARE
    i INTEGER;
    usuario_id UUID;
    senha_hash TEXT := '$2b$10$MHPPobIlF98g9I3RENiRx.FZbqxjQ6tcq4vop.hrh2QCWvlw5tau6'; -- hash da senha 'Teste@123'
BEGIN
    -- Criar 10 clientes
    FOR i IN 1..10 LOOP
        -- Inserir usuário
    ...
    FOR i IN 1..10 LOOP
        ...
        INSERT INTO estabelecimentos (
            "id", "num_cnpj", "email", "num_celular", "nome_estab", "razao_social",
